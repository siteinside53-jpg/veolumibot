...
# Fallback domain (αν λείπει το WEBAPP_URL)
FALLBACK_WEBAPP_BASE = "https://veolumibot-production.up.railway.app"
...
# -----------------------
# EXTRA: button κάτω από Profile text (αν το χρησιμοποιείς στο bot.py)
# -----------------------
